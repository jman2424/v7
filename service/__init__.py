"""
Services package exports & light factories.
...
class CRMLike(Protocol):
    def upsert_lead(self, tenant: str, *, name: Optional[str], phone: Optional[str],
                    channel: str, session_id: str, tags: Optional[list[str]] = None) -> Dict[str, Any]: ...
    def append_conversation(self, tenant: str, lead_id: str, message: Dict[str, Any]) -> None: ...

class CatalogStoreLike(Protocol):
    def search(self, text: Optional[str] = None, tags: Optional[list[str]] = None, limit: int = 10): ...
...
class FAQStoreLike(Protocol):
    def best_match(self, user_question: str, *, hint_tags: Optional[list[str]] = None,
                   min_sim: float = 0.18, top_k: int = 1) -> list[Dict[str, Any]]: ...
