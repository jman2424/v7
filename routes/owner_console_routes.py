...
def _serve_console(asset_path: str = ""):
    ...
    screens = {"pipeline", "test", "implementation", "usage", "conversations", "agent", "website", "integrations", "catalog", "offers", "faqs", "delivery", "profile", "branches", "team", "companies", "errors"}
