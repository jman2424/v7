...
def _serve_console(asset_path: str = ""):
    ...
    screens = {"subscription", "platform", "pipeline", "statistics", "test", "implementation", "whatsapp-qr", "usage", "conversations", "agent", "website", "integrations", "catalog", "offers", "faqs", "delivery", "profile", "branches", "team", "companies", "errors"}
